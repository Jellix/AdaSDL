...
package body Game.Audio is
   ...
   procedure Load_Data is
      ...
      Ping_Buffer : aliased SDL.Types.Uint8_ptr     := SDL.Types.Uint8_ptr (Conv.To_Pointer (System.Address (WAV_Ping.Buffer)));
      Pong_Name   : aliased Interfaces.C.char_array := Interfaces.C.To_C ("../data/pong.wav");
      Pong_Buffer : aliased SDL.Types.Uint8_ptr     := SDL.Types.Uint8_ptr (Conv.To_Pointer (System.Address (WAV_Pong.Buffer)));
   begin
      if
