...
package SDL.Audio is
   ...
   subtype Volume is Int range 0 .. MAX_MIX_VOLUME;
   ...
   --  initialized. Initializing a Conversion reoord is a two step
   ...
   --  length.
   --
   --  Once the Conversion structure is initilaized then we can pass it
